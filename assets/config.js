(function () {
  ...
  const STAT_LABEL_OVERRIDES = Object.freeze({
    ...
    playerScoringEfficiency: "Scoring Efficiency",
    playerAttackInvolvementRate: "Attack Involvement Rate",
    playerTurnoverCostRate: "Turnover Cost Rate",
    playerDefensiveDisruption: "Defensive Disruption",
    playerPressureBalance: "Pressure Balance",
    teamFinishingEfficiency: "Finishing Efficiency",
    teamBallSecurityRate: "Ball Security Rate",
    teamDisruption: "Team Disruption",
    teamPossessionControlBalance: "Possession Control Balance",
  ...
  const STAT_ABBREV_OVERRIDES = Object.freeze({
    ...
    netPoints: "Net Pts",
    playerScoringEfficiency: "Score Eff",
    playerAttackInvolvementRate: "Atk Involve",
    playerTurnoverCostRate: "TO Cost",
    playerDefensiveDisruption: "Disruption",
    playerPressureBalance: "Press Bal",
    teamFinishingEfficiency: "Finish Eff",
    teamBallSecurityRate: "Ball Sec",
    teamDisruption: "Disruption",
    teamPossessionControlBalance: "Control Bal",
