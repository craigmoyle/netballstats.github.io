...
var effectivePostgresPrivateDnsZoneName = empty(postgresPrivateDnsZoneName) ? '${postgresServerName}.private.postgres.database.azure.com' : postgresPrivateDnsZoneName
